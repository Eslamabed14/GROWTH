        ...
        function se(e, t, n, r) {
            ...
            if (!r && (T(t), (t = t || C), E)) {
                ...
                if (
                    ...
                    if (
                        ((c = e), (f = t), 1 === p && (V.test(e) || X.test(e)))
                    ) {
                        for (
                            ((f = (ne.test(e) && ge(t.parentNode)) || t) ===
                                t &&
                                d.scope) ||
                                ((s = t.getAttribute("id"))
                                    ? (s = s.replace(ie, oe))
