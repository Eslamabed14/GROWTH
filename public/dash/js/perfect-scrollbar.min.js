!(function (t, e) {
    ...
    function w(t, e) {
        r[e] = setTimeout(function () {
            return (
                t.isAlive && t.element.classList.remove(W.state.scrolling(e))
            );
    ...
    function y(t) {
        ...
        (t.containerWidth = e(r.width)),
            ...
            i.contains(t.scrollbarXRail) ||
                (o(i, W.element.rail("x")).forEach(n),
                i.appendChild(t.scrollbarXRail)),
            i.contains(t.scrollbarYRail) ||
                (o(i, W.element.rail("y")).forEach(n),
    ...
    function h(t, e) {
        ...
        (this.scrollbarXBottom = parseInt(a.bottom, 10)),
            isNaN(this.scrollbarXBottom)
                ? ((this.isScrollbarXUsingBottom = !1),
                  (this.scrollbarXTop = b(a.top)))
                : (this.isScrollbarXUsingBottom = !0),
            (this.railBorderXWidth =
                b(a.borderLeftWidth) + b(a.borderRightWidth)),
        ...
        (this.scrollbarYRight = parseInt(u.right, 10)),
            ...
            (this.railBorderYWidth =
                b(u.borderTopWidth) + b(u.borderBottomWidth)),
            ...
            wheel: function (b) {
                function t(t) {
                    var e,
                        ...
                        f = d[1];
                    !(function (t, e, i) {
                        if (!L.isWebKit && g.querySelector("select:focus"))
                            return 1;
                        if (g.contains(t))
                            for (var l = t; l && l !== g; ) {
                                if (l.classList.contains(W.element.consuming))
                                    return 1;
                                var r = Y(l);
                        ...
                        b.settings.useBothWheelAxes
                            ? b.scrollbarYActive && !b.scrollbarXActive
                                ? (f
                                      ? (g.scrollTop -=
                                            f * b.settings.wheelSpeed)
                                      : (g.scrollTop +=
                                            p * b.settings.wheelSpeed),
                                  (r = !0))
                                : b.scrollbarXActive &&
                                  !b.scrollbarYActive &&
                                  (p
                        ...
                        (r =
                            ...
                            (h = 0 === g.scrollLeft),
                            (u =
                                g.scrollLeft + g.offsetWidth === g.scrollWidth),
                            !(v(o) > v(n) ? a || c : h || u) ||
